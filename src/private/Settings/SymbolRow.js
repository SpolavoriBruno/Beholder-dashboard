...
function SymbolRow(props) {
    ...
    return (<tr>
        ...
        <td className="text-gray-900">
            <button id={`edit/${data.symbol}`} className="btn btn-secondary animate-up-2" width={32}>
                <svg id={`edit/${data.symbol}`} className="icon icon-xs" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
